    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ActivityCompat.startActivity(SudokuListActivity.this, playSudoku(id), ActivityOptionsCompat.makeSceneTransitionAnimation(SudokuListActivity.this, new Pair<>(view.findViewById(R.id.sudoku_board), "board")).toBundle());
            }
        });
        ...
        switch (id) {
            ...
            case DIALOG_FILTER:
                return new AlertDialog.Builder(this)
                        ...
                        .setMultiChoiceItems(
                                R.array.game_states,
                                new boolean[]{mListFilter.showStateNotStarted, mListFilter.showStatePlaying, mListFilter.showStateCompleted},
